...
const BanknoteIcon = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      ...
      stroke-width="1.7"
    />
    <path d="M7.33398 20V12" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" />
    <path d="M24.666 20V12" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" />
  </svg>
);
